      ...
      <header className="relative bg-[rgb(24,18,146)] h-[58rem] sm:h-[55rem] md:h-[45rem] text-white overflow-hidden">
        <div className="mt-20 max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 py-20 gap-10">
          <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-xl">
            <h1
              className="text-4xl sm:text-5xl font-bold mb-6 leading-tight text-[#c8ed4e]"
              data-aos="fade-up"
            >
            ...
            <div className="flex flex-col sm:flex-row gap-4" data-aos="fade-up">
              <button
                className="bg-[#b2dc28] text-[rgb(24,18,146)] font-semibold px-6 py-3 rounded-full shadow-md hover:bg-gray-100 transition"
                onClick={() => scrollToSection("price-proyects")}
              >
                Start a Project
              </button>
              <button 
